 ...
 * can never carry an app CSRF token, such as the Telegram webhook — skip
 * CSRF validation entirely while every other request is checked exactly as
 * before.
 */
final class CsrfExemptMiddleware implements MiddlewareInterface
{
    private const EXEMPT_PATH_SUBSTRINGS = [
        '/shell/telegram/webhook',
    ];
